...
class Verification(commands.Cog):
    def __init__(self, bot):
        ...
        self.role_m_id = "1535400182101966929"            # ID роли Мужской ♂
        self.role_w_id = "1535399827163324496"            # ID роли Женский ♀
        self.role_not_verified_id = "1535403124926185604"  # ID роли новичка (@not verified)
        
        self.log_channel_id = "1536794177067683920"        # СЮДА ID КАНАЛА ДЛЯ ЛОГОВ (#logs-вериф)
        # =================================================================
