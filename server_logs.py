...
class ServerLogs(commands.Cog):
    def __init__(self, bot):
        ...
        self.log_punish_id = "1536794177067683920"       # ⛔ наказания
        self.log_sponsors_id = "1536794177067683920"     # 💎 спонсоры
        self.log_monitoring_id = "1536794177067683920"   # 📋 логи-мониторинг (Входы/выходы из войсов)
        self.log_loverooms_id = "1536794177067683920"    # 💍 лаврумы (Обычно обрабатывается в коге экономики/свадеб)
        self.log_verification_id = "1536794177067683920" # 📁 логи-верификаций (Уже настроено в verification.py)
        self.log_custom_roles_id = "1536794177067683920" # 🎀 личные-роли (Изменения ролей участников)
        self.log_private_rooms_id = "1536794177067683920"# 🧸 личные-комнаты (Обрабатывается в private_voice.py)
        self.log_reviews_id = "1536794177067683920"      # 📁 отзывы
        self.log_admin_id = "1536794177067683920"        # 💔 действия-админов
        self.log_automod_id = "1536794177067683920"      # 💫 автомод
        self.log_joins_id = "1536794177067683920"        # 📊 зашедшие
        self.log_anticrash_id = "1536794177067683920"    # 💫 антикраш (Для будущей системы защиты)
        # ===============================================================================
