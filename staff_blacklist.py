...
# ================= НАСТРОЙКИ ЧС =================
BLACKLIST_CHANNEL_ID = 1536794177067683920 # Замени на ID канала, куда будут падать логи ЧС
BLACKLIST_ROLE_ID = 1536794177067683920 # Замени на ID роли "ЧС Стаффа" (если оставить 0, роль выдаваться/сниматься не будет)
# ================================================
